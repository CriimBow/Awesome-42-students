...
#### Nourriture
- [Nestor](https://nestorparis.com) : (renseigner l'adresse "96 Boulevard Bessières, 75017 Paris" avec le coupon *NETSTOR42*)

#### Ressources informatiques
- [Lucidchart](https://www.lucidchart.com/pages/usecase/education) : Outil de diagrammes (renseigner votre adresse mail étudiante)
- [JetBrains](https://www.jetbrains.com/) : Ensemble d'IDE (renseigner votre adresse mail étudiante)
- [Office 365 Éducation](https://www.microsoft.com/fr-fr/education/products/office) (renseigner votre adresse mail étudiante)
- [YesWeHackEdu](https://docs.google.com/forms/d/e/1FAIpQLSeLwXC0STvJDtVP4U7eluXVVqBiJaDHAHFsXpsRKI0iwgMJmw/viewform) : Apprenez le bug bounty
